...
fx_register_block(
    [
        ...
        'template'      => 'homepage/quick-links.php',
        'description'   => 'block for the homepage quicklinks.',
        'css'           => 'homepage/quick-links.css',
        'category'      => 'fx-homepage-blocks',
    ]
);
...
fx_register_block(
    [
        'name'          => 'homepage-sales-image-buttons',
        'title'         => 'Homepage - Sales Image Buttons',
        'template'      => 'homepage/sales-image-buttons.php',
        'description'   => 'block for the Sales Image Buttons.',
        'css'           => 'homepage/half-box-image-text.css',
...
fx_register_block(
    [
        'name'          => 'homepage-icon-buttons',
        'title'         => 'Homepage - Icon Buttons',
        'template'      => 'homepage/icon-buttons.php',
        'description'   => 'block for the Icon Buttons.',
...
fx_register_block(
    [
        'name'          => 'innerpage-contact-form',
        'title'         => 'Innerpage - Contact Form',
        'template'      => 'innerpage/contact-form.php',
        'description'   => 'Contact Form Block',
        'css'           => 'innerpage/page-contact.css',
        'css_deps'      => [ 'fx_choices_plugin' ],
        //'js'            => 'homepage/date-picker.js',
        'js_deps'       => [ 'fx_choices' ],
...
/* Contained Video Text */

fx_register_block(
    [
        'name'          => 'innerpage-half-video-text',
        'title'         => 'Innerpage - Contained Video Text',
        'template'      => 'innerpage/contained-video-text.php',
        'description'   => 'Contained Video Text Block',
        'css'           => 'innerpage/contained-video-text.css',
        'css_deps'      => [ 'fx_lightbox' ],
        //'js'            => 'homepage/date-picker.js',
        'js_deps'       => [ 'fx_lightbox' ],
        'category'      => 'fx-innerpage-blocks',
    ]
...
/* Innerpage - Half Image Half Text */

fx_register_block(
    [
        'name'          => 'innerpage-half-image-half-text',
        'title'         => 'Innerpage - Half Image Half Text Block',
        'template'      => 'innerpage/half-image-half-text.php',
        'description'   => 'This is a half image and half text block',
        'css'           => 'innerpage/half-image-half-text.css',
        //'css_deps'      => [ 'fx_readmore' ],
        //'js'            => 'homepage/date-picker.js',
        //inc'js_deps'       => [ 'fx_readmore' ],
        'category'      => 'fx-innerpage-blocks',
    ]
);


/* Innerpage - Image Text Block */

fx_register_block(
    [
        'name'          => 'innerpage-image-text-block',
        'title'         => 'Innerpage - Image Text Block',
        'template'      => 'innerpage/image-text.php',
        'description'   => 'This is an image text block',
        'css'           => 'innerpage/contained-image-text.css',
        //'css_deps'      => [ 'fx_readmore' ],
        //'js'            => 'homepage/date-picker.js',
        //inc'js_deps'       => [ 'fx_readmore' ],
        'category'      => 'fx-innerpage-blocks',
...
/* Innerpage - CTA Bar Block */

fx_register_block(
    [
        'name'          => 'innerpage-cta-bar-block',
        'title'         => 'Innerpage - CTA Bar Block',
        'template'      => 'innerpage/cta-bar.php',
        'description'   => 'This is a CTA Bar block',
...
/* Innerpage - CTA Newsletter Block */

fx_register_block(
    [
        'name'          => 'innerpage-cta-newsletter-block',
        'title'         => 'Innerpage - CTA Newsletter Block',
        'template'      => 'innerpage/cta-newsletter.php',
        'description'   => 'This is a CTA Newsletter block',
        'css'           => 'innerpage/cta-newsletter.css',
        //'css_deps'      => [ 'fx_readmore' ],
        //'js'            => 'homepage/date-picker.js',
        //inc'js_deps'       => [ 'fx_readmore' ],
        'category'      => 'fx-innerpage-blocks',
