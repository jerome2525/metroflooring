...
var FX = ( function( FX, $ ) {
	...
	FX.General = {
		...
		bind() {
			...
			$('.js-search-toggle').on('click', () => {
				$('.mobile-menu__search').toggleClass('js-search-active');
                $('.mobile-menu__search input[name="s"]').focus();
			});
			
			$('.quick-links-info p').each(function(){
    ...
    FX.MobileMenus = {
        init: function() {
            ...
            $('.mobile-nav li.menu-item-has-children > a').after('<span class="sub-menu-toggle icon-arrow-down"></span>');
